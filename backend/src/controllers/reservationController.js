...
//     }
//     try {
//         const { accomodationId, startDate, endDate, user } = req.body;
...
//         const newReservation = new Reservation({ accomodation: accomodationId, user: user.email, startDate, endDate, });
